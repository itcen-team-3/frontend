...
interface FamilyCareLogDetailProps {
  id?: string;
  patientName?: string;
...
export function FamilyCareLogDetail({
  // id = "1",
  patientName = "이환자",
  caregiverName = "김요양",
  ...
  // 날짜 포맷팅
  const formattedDate = format(new Date(date), "yyyy년 MM월 dd일 (eee)", {
    locale: ko,
  });
  ...
  return (
    <PageContainer>
      <div className="flex items-center mb-6">
        ...
        <PageHeader
          title="돌봄일지 상세"
          description={`${patientName}님 - ${formattedDate}`}
      ...
      <div className="grid gap-6">
        ...
        <Card className="card-shadow">
          <CardHeader>
            <CardTitle className="text-xl">요양보호사 정보</CardTitle>
          </CardHeader>
          <CardContent>
